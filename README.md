...
5 - Fazer comando para que inicie o Raspberry rodando a aplicação:
    a) Abra o arquivo .profile que está no diretório home/pi e execute: sudo mousepad .profile.Abrirá o editor de texto e na ultima linha depois de "fi" digite o comando que executará o arquivo python: 
    cd /home/pi/Histo_V6
